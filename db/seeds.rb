...
m3 = Message.create(user_id: 1, tomodachi_id: 2, chat_id: 1, content: "i think you're great", valentime: Time.now)
m4 = Message.create(user_id: 1, tomodachi_id: 2, chat_id: 1, content: "thanks :)", valentime: Time.now)
m5 = Message.create(user_id: 2, tomodachi_id: 3, chat_id: 2, content: "omg hi", valentime: Time.now)
m6 = Message.create(user_id: 2, tomodachi_id: 3, chat_id: 2, content: "whats up", valentime: Time.now)
m7 = Message.create(user_id: 2, tomodachi_id: 3, chat_id: 2, content: "everything is perfect", valentime: Time.now)
m8 = Message.create(user_id: 2, tomodachi_id: 3, chat_id: 2, content: "i know :)", valentime: Time.now)
